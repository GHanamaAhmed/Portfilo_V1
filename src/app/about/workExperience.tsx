  ...
  return (
    <div className="w-full flex flex-col gap-2 py-4 border-b-2 dark:border-lightContent">
      <div className="w-full flex gap-y-3 mb-2 flex-col md:flex-row justify-between md:items-center">
        <p className="text-darkContent dark:text-lightContent text-lg">
          {skill}
        </p>
        {typeEmployment && (
          <div className="py-1 px-3 bg-buttonSuccess w-fit text-buttonText rounded-full font-semibold">
            {typeEmployment}
          </div>
        )}
      </div>
        ...
        <div className="flex md:gap-x-10">
          {adress && (
            <div className="flex gap-1">
              ...
              <p className="text-darkContent dark:text-lightContent text-sm md:text-base">
                {adress}
              </p>
            </div>
          )}
