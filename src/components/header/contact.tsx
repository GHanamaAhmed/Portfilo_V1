...
export default function Contact() {
  return (
    <>
      <li>
        <a href={aboutMe.links.github} target="_blank">
          {" "}
          <svg
      ...
      <li>
        <a href={aboutMe.links.upwork} target="_blank">
          {" "}
          <svg
            className="w-7"
          ...
          >
            <path
              ...
              className="fill-darkContent dark:fill-lightContent"
            />
            <path
      ...
      <li>
        <a href={aboutMe.links.linkedin} target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-7 fill-darkContent dark:fill-lightContent"
            viewBox="0 0 448 512"
